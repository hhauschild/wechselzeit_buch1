package de.wechselzeit.views.übersicht;
...
import de.wechselzeit.views.übersicht.ServiceHealth.Status;

@PageTitle("Übersicht")
@Route(value = "dashboard", layout = MainLayout.class)
@AnonymousAllowed
public class ÜbersichtView extends Main {

    public ÜbersichtView() {
        addClassName("übersicht-view");
